...
import { getCurrentSectionId, getSoundIdx } from 'store/modules/App/selectors';
...
import { toChangeSoundIdx } from 'store/modules/App/actions';
      ...
      {(isMenuOpen || !isMenuHaveDialogView) && (
        ...
        >
          <Grid container className={'logoContainer'}>
            <SvgAnimation id={id} pathsArr={Array(4).fill(path)} viewBox={'0 0 600 800'} className={'svgContainer'}>
              <Grid container>
